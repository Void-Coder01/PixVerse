...
const Header = () => {
    ...
    return(
        ...
        viewport={{once : true}}
        >
            <motion.div className='inline-flex text-stone-500 text-center gap-2 border border-neutral-500 rounded-full bg-white px-6 py-1'
            ...
            initial={{opacity:0}}
            animate={{opacity : 1}}
            transitioin={{delay : 0.4, duration: 2}}
            ...
            className='text-center max-w-xl mx-auto mt-5 font-medium'>Unleash your creativity with AI. Turn your imagination into visual art in seconds - just type, and watch the magic happen</motion.p>
