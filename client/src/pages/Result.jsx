    ...
    return (
        ...
        className='flex flex-col min-h-[90vh] justify-center items-center'>
            ...
            {!isImageLoaded && 
                ...
                <button type='submit' 
                className='bg-zinc-900 px-10 sm:px-16 py-3 rounded-full cursor-pointer'>Generate</button>
            
            </div>
            }

            {/*  agr image generate hogya tabhi yeh visible hoga  */}
            {isImageLoaded && 
                ...
                <p  onClick={() => {setIsImageLoaded(false)}}
                    className='p-8 py-3 rounded-full cursor-pointer bg-transparent border border-zinc-900 text-black' >Generate Another</p>
                <a href={image} download className='bg-zinc-900 px-10 py-3 rounded-full cursor-pointer'>Download</a>
                {/*  href = {image} yeh download krneka access dega */}
            </div>
            }
