...
const App = () => {
    ...
    const {isUserLoggedIn, backendurl, loadCreditsData, token, setShowLogin} = useContext(AppContext);
        ...
        className='min-h-[90vh] text-center pt-14 mb-10'>
            ...
            <div className='flex flex-wrap justify-center gap-6 text-left'>
                {plans.map((item,index) => (
                    ...
                    duration-500'>
                        <img width={50} src={assets.pixverse_camera_logo}  alt="" />
                        ...
                        className='w-full bg-gray-800 text-white mt-8 text-sm rounded-md py-2.5 min-w-52 cursor-pointer'>{ isUserLoggedIn ? 'Purchase' : 'Get Started'}</button>
